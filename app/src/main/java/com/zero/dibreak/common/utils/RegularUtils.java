...
public class RegularUtils {
     ...
     * 验证纬度
     */
    private static final String REGEX_LAT = "^(\\+|-)?(?:90(?:(?:\\.0{1,7})?)|(?:[0-9]|[1-8][0-9])(?:(?:\\.[0-9]{1,7})?))$";
    /**
     * 验证经度
     */
    private static final String REGEX_LNG = "^(\\+|-)?(?:180(?:(?:\\.0{1,7})?)|(?:[0-9]|[1-9][0-9]|1[0-7][0-9])(?:(?:\\.[0-9]{1,7})?))$";
    /**
     * 验证邮箱
     */
    ...
    public static boolean isLat(String str) {
        return isMatch(REGEX_LAT, str);
    }

    public static boolean isLng(String str) {
        return isMatch(REGEX_LNG, str);
    }
    ...
    public static boolean isPasswordValid(String string) {
        ...
        Matcher matno = patno.matcher(string);
        Matcher maten = paten.matcher(string);
